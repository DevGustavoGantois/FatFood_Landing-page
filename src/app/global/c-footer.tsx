  ...
  return (
    <footer className="w-full bg-gradient-to-b from-[#E53935] to-[#7F201D]/80 py-10 mt-20 lg:mt-[100px] rounded-t-3xl">
      {footerData.map((item, index) => (
        <div key={index} className="max-w-[1440px] mx-auto px-6">
          <div className="flex flex-col gap-6 items-center justify-center text-center">
            <Image
              ...
              priority
            />
            <p className="text-white text-center max-w-[750px]">
              {item.description}
            </p>
            ...
            <div className="border-t border-gray-200/20 w-full mt-6 pt-4 flex flex-col lg:flex-row items-center justify-between gap-2">
